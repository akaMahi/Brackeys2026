...
#
# Zoom reacts continuously to the car's speed — zoomed IN while slow,
# zoomed OUT while fast. (zoom < 1.0 = zoomed in, zoom > 1.0 = zoomed
# out — that's Godot's Camera2D convention, the opposite of how a real
# camera lens is usually described.) On top of that, rotation and zoom
# get a reactive "kick" while the car is drifting.
#
